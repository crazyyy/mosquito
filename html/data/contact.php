...
if (empty($action)) {
	...
	<div class='contact-content'>
      ...
      <input type='text' id='contact-name' class='contact-input' name='name' placeholder='Введите Ваше имя' tabindex='1001'>
			...
			<input type='text' id='contact-email' class='contact-input' name='phone' placeholder='Введите номер телефона' tabindex='1002' />
	...
	if ($token === smcf_token($to)) {
		...
		echo "Возможно мы не можем проверить ваше сообщение.";
	}
}
